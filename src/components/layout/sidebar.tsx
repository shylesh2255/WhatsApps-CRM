...
export function Sidebar({ open = false, onClose }: SidebarProps) {
  ...
  const sidebarLabel = (labelKey: string) => {
  ...
  const showAccountStrip =
    ...
    (accountRole === 'owner' || accountRole === 'admin') &&
    !!displayCompanyName &&
    displayCompanyName !== profile?.full_name;
