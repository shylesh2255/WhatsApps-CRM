...
export function InvoiceForm({ open, onOpenChange, onSaved }: InvoiceFormProps) {
  ...
  async function handleSave() {
    ...
    try {
      ...
      const { error: itemsError } = await supabase.from("crm_invoice_items").insert(
      ...
      >
        <div className="flex h-full flex-col">
          <SheetHeader className="border-b border-border/50 p-4">
            <SheetTitle className="text-popover-foreground">New Invoice</SheetTitle>
          </SheetHeader>
